...
- 支持语义打断固定回复：播放“我在，有什么可以帮到您的”时仍监听拍照命令；拍照小语法覆盖“拍照 / 拍张照 / 拍一张照片 / 帮我拍照 / 照相”等说法，并兼容 Vosk 常见的“拍 [unk] / [unk] 照 / 牌照 / 拍到”结果。
...
当前语音服务在检测到“你好小环 / 您好小环”后，会先播放固定回复“我在，有什么可以帮到您的”。固定回复播放期间也会监听拍照小语法；如果识别到拍照命令，会停止当前固定回复并立即开始播放“好的，已拍照”，同时在后台向 RGBD 发送端写入拍照请求。固定回复自然播放结束后也会等待约 0.3 秒尾音，并默认开启 8 秒命令窗口。
